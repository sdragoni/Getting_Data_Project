...
These files were imported into dataframes with names that corresponded to the original file names

There is a full description of this data here
http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones 

THe final dataset was generated by combining the activity, y and the columns from the X dataframes containing the mean and std.
